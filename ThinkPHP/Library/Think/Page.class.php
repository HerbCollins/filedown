...
class Page{
    ...
    public function show() {
        ...
        $up_page = $up_row > 0 ? '<li><a class="prev" href="' . $this->url($up_row) . '" aria-label="Previous">' . $this->config['prev'] . '</a></li>' : '';

        //下一页
        $down_row  = $this->nowPage + 1;
        $down_page = ($down_row <= $this->totalPages) ? '<li><a class="next" href="' . $this->url($down_row) . '" aria-label="Next">' . $this->config['next'] . '</a></li>' : '';
