			...
			<div class="col-xs-12 col-sm-8 col-md-9 col-lg-10">
				<div class="row">
					<div class="col-xs-12">
						<h3><?php echo ($type); ?></h3>
						<hr>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$file): $mod = ($i % 2 );++$i;?><div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
								<div class="box">
									<a href="<?php echo U('Home/File/detail',array('id'=>encode($file['id'])));?>"  target="_blank"><img src="<?php echo (getImgPath($file["first_cover"])); ?>?	
